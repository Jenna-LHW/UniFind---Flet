...
def browse_found_view(page: ft.Page, go):
    ...
    loading    = ft.ProgressRing(visible=False, color=GREEN, width=24, height=24)
    ...
    def load(keyword='', category=''):
        ...
        if not items:
            results.controls.append(
                ft.Container(
                    content=ft.Column([
                        ft.Icon(ft.Icons.INVENTORY_2_OUTLINED, color='#c4bdb4', size=48),
                        ft.Text('No found items reported', color='#9a8f80', size=14),
    ...
    def select_cat(cat_val, btn_row):
        ...
        for btn in btn_row.controls:
            ...
            btn.style = ft.ButtonStyle(
                color='white' if is_sel else GREEN,
                bgcolor=GREEN if is_sel else 'white',
    ...
    for val, label in zip(CATEGORIES, CAT_LABELS):
        is_sel = val == ''
    ...
    return ft.Column([
        ft.Container(
            content=ft.Row([
                ...
                ft.IconButton(ft.Icons.SEARCH_ROUNDED, on_click=do_search,
                              bgcolor=GREEN, icon_color='white', icon_size=20),
            ], spacing=8),
        ...
        ft.Container(
            content=ft.Row([
                ...
                ft.Text('Report a Found Item', size=13, color='white', weight=ft.FontWeight.W_500),
            ...
            content=ft.Row([
                ...
                ft.Column([
                    ...
                    ft.Row([
                        ...
                        ft.Text(item.get('found_at', '')[:35], size=11, color='#7a7670',
                                overflow=ft.TextOverflow.ELLIPSIS, expand=True),
                    ], spacing=2),
                    ft.Row([
                        ft.Icon(ft.Icons.CALENDAR_TODAY_OUTLINED, size=11, color='#9a8f80'),
                        ft.Text(str(item.get('date_found', '')), size=11, color='#9a8f80'),
                    ], spacing=2),
